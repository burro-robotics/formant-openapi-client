 ...
 *
 * @export
 * @interface SuggestionControllerCreateStructuredSuggestionRequestStructuresInner
 */
export interface SuggestionControllerCreateStructuredSuggestionRequestStructuresInner {
    /**
     *
     * @type {string}
     * @memberof SuggestionControllerCreateStructuredSuggestionRequestStructuresInner
     */
    'name': string;
    /**
     *
