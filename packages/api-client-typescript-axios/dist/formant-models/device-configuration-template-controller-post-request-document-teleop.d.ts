 ...
 *
 * @export
 * @interface DeviceConfigurationTemplateControllerPostRequestDocumentTeleop
 */
export interface DeviceConfigurationTemplateControllerPostRequestDocumentTeleop {
    /**
     *
     * @type {Array<DeviceConfigurationTemplateControllerPostRequestDocumentRealtimeRosStreamsInner>}
     * @memberof DeviceConfigurationTemplateControllerPostRequestDocumentTeleop
     */
